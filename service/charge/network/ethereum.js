...
const self = {
            ...
            W3.eth.getTransactionReceipt(hash).then((data) => {
                ...
                const result={
                    ...
                    block:{                                 //transaction details
                        ...
                        index:dt.transactionIndex,
                    },
                    contract:contract,                    //contract address, to confirm the right ERC20 token
                }
                return ck && ck(result);
            });
        });
    ...
    token: async (val) => {
        ...
        //const aa=188000000000000000000n;
        const amount = web3.utils.toHex(val);
