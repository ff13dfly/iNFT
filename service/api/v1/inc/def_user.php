...
define('USER_MOBILE_DELAY',	60);			//短信请求的间隔(s)
define('USER_VCODE_LENGTH',	6);			//短信请求的间隔(s)
...
define('VCODE_SUFFIX','vcd');					//非注册用户的name
define('VCODE_CHECK_PRE', 'vck_');		//60s防止重复发送短信
define('MOBILE_REG_MAX', 1);				//单个手机注册的上限